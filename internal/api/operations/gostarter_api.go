...
func NewGostarterAPI(spec *loads.Document) *GostarterAPI {
	return &GostarterAPI{
...
/*GostarterAPI the gostarter API */
type GostarterAPI struct {
	spec            *loads.Document
	...
	HealthHealthReadinessHandler health.HealthReadinessHandler
...
func (o *GostarterAPI) UseRedoc() {
	o.useSwaggerUI = false
}

// UseSwaggerUI for documentation at /docs
func (o *GostarterAPI) UseSwaggerUI() {
	o.useSwaggerUI = true
}

// SetDefaultProduces sets the default produces media type
func (o *GostarterAPI) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *GostarterAPI) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// SetSpec sets a spec that will be served for the clients.
func (o *GostarterAPI) SetSpec(spec *loads.Document) {
	o.spec = spec
}

// DefaultProduces returns the default produces media type
func (o *GostarterAPI) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *GostarterAPI) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *GostarterAPI) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *GostarterAPI) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the GostarterAPI
func (o *GostarterAPI) Validate() error {
	...
	if o.HealthHealthReadinessHandler == nil {
		unregistered = append(unregistered, "health.HealthReadinessHandler")
	}
...
func (o *GostarterAPI) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}
...
func (o *GostarterAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
...
// MIME type parameters are ignored here.
func (o *GostarterAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
...
func (o *GostarterAPI) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
// Context returns the middleware context for the gostarter API
func (o *GostarterAPI) Context() *middleware.Context {
	if o.context == nil {
...
func (o *GostarterAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/healthz/liveness"] = health.NewHealthLiveness(o.context, o.HealthHealthLivenessHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/healthz/readiness"] = health.NewHealthReadiness(o.context, o.HealthHealthReadinessHandler)
}

// Serve creates a http handler to serve the API over HTTP
// can be used directly in http.ListenAndServe(":8000", api.Serve(nil))
func (o *GostarterAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
...
func (o *GostarterAPI) RegisterConsumer(mediaType string, consumer runtime.Consumer) {
	o.customConsumers[mediaType] = consumer
}

// RegisterProducer allows you to add (or override) a producer for a media type.
func (o *GostarterAPI) RegisterProducer(mediaType string, producer runtime.Producer) {
	o.customProducers[mediaType] = producer
}

// AddMiddlewareFor adds a http middleware to existing handler
func (o *GostarterAPI) AddMiddlewareFor(method, path string, builder middleware.Builder) {
	um := strings.ToUpper(method)
	if path == "/" {
		path = ""
	}
