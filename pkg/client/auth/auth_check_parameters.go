...
// WithDefaults hydrates default values in the auth check params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *AuthCheckParams) WithDefaults() *AuthCheckParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the auth check params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *AuthCheckParams) SetDefaults() {
